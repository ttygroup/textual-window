...
class CloseButton(NoSelectStatic):
    ...
    class LowestChildResized(Message):
        pass
    ...
    def on_resize(self):
        self.post_message(self.LowestChildResized())
...
class Window(Widget):
    ...
    "The lock state of the window. You can modify this directly if you wish."
    ...
    def __init__(
        ...
        *children: Widget,
        ...
        self.set_reactive(Window.open_state, start_open)    # Don't want to trigger the open/close animation here.         
    ...
    def _close_animation(self):
        ...
        if self.animated:
            self.styles.animate(
                "opacity", 0.0, duration=self.animation_duration, on_complete=_close_animation_callback
            )
        else:
            self.display = False
